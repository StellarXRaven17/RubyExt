...
@Mod("rubyext")
public class RubyextMod {
	public static final Logger LOGGER = LogManager.getLogger(RubyextMod.class);
	public static final String MODID = "rubyext";

	public RubyextMod(FMLJavaModLoadingContext context) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = context.getModEventBus();
		RubyextModSounds.REGISTRY.register(bus);
